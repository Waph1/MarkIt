...
public final class LabelDao_Impl implements LabelDao {
  ...
  @Override
  public Object insert(final LabelEntity label, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfLabelEntity.insert(label);
  ...
  @Override
  public Object delete(final String name, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  public Flow<List<String>> getAllLabels() {
    final String _sql = "SELECT name FROM labels ORDER BY name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"labels"}, new Callable<List<String>>() {
      @Override
      @NonNull
